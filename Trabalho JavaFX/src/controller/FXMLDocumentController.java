...
public class FXMLDocumentController implements Initializable {
    ...
    @FXML
    private TableColumn<Anime, Integer> tlStatus;

    @FXML
    private TableColumn<Anime, String> tlProgresso;
    ...
    public void atualizaTabela(){
        ...
        System.out.print(db.getConnectionStatus());
    ...
    @FXML
    void cliqueBotaoEditar(MouseEvent event) throws SQLException, IOException{
        Database db = new Database();
        db.startConnection();
        if(tbListaAnimes.getSelectionModel().getSelectedItem() != null){
            Anime editar = tbListaAnimes.getSelectionModel().getSelectedItem();
            
            Node node = (Node) event.getSource();    
            Stage stage = (Stage) node.getScene().getWindow();

            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/view/FXMLView3.fxml"));
            Parent root = loader.load();
            FXMLDocumentControllerView3 controller = loader.getController();
            controller.setAtributo(editar);
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.show();          
        }
